...
import { ArrowLeft, Plus, TrendingDown, ArrowUpRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-100 dark:bg-[#0a0a0a] p-4 lg:p-8">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-4 mb-2">
                    <Link
                        href="/dashboard"
                        className="lg:hidden p-2 hover:bg-white dark:hover:bg-white/5 rounded-lg transition-colors"
                    >
                        <ArrowLeft className="w-5 h-5 text-gray-900 dark:text-white" />
                    </Link>
                    <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Analytics</h1>
                </div>
                <p className="text-gray-500 dark:text-gray-400">Understand your spending patterns</p>
            </div>

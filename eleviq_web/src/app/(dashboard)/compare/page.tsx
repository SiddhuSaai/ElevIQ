...
export default function ComparePage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] p-4 lg:p-8">
            <div className="mb-8">
                <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Compare Spending</h1>
                <p className="text-gray-500 dark:text-gray-400 mt-1">Month-over-month spending comparison</p>
            </div>

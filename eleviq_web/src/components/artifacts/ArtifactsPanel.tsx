...
export default function ArtifactsPanel() {
    ...
    const handleCopy = async () => {
        ...
        if (activeArtifact.type === 'csv' || activeArtifact.type === 'code' || activeArtifact.type === 'html') {
    ...
    return (
        <div className={`h-full flex flex-col border-l ${actualTheme === 'dark'
            ...
            <div className={`flex items-center justify-between px-4 py-3 border-b ${actualTheme === 'dark'
                ...
                <div className="flex items-center gap-1 ml-2">
                    ...
                    {activeArtifact && (activeArtifact.type === 'csv' || activeArtifact.type === 'code' || activeArtifact.type === 'html') && (
                        <button
                            onClick={handleCopy}
